...
export const translations = {
  ...
  landing: {
    ...
    heroLine1:     { en: "See what's above",                     ka: 'ნახე რა ჩანს' },
    heroLine2:     { en: 'Tbilisi tonight',                      ka: 'დღეს ღამე ცაზე' },
    heroSub:       { en: 'The free astronomy platform for Georgia. Log observations, earn points, compete.', ka: 'უფასო ასტრონომიის პლატფორმა საქართველოსთვის. ჩაწერე დაკვირვებები, დააგროვე ქულები, შეეჯიბრე.' },
    startBtn:      { en: 'Start Missions →',                     ka: 'მისიების დაწყება →' },
    ...
    tonightSub:    { en: 'Real-time visibility from Tbilisi',     ka: 'რეალური მონაცემები თბილისიდან' },
    visibleCount:  { en: 'objects visible tonight',              ka: 'ობიექტი ხილულია ღამით' },
    altitude:      { en: 'peak alt',                             ka: 'მაქს. სიმაღლე' },
    bestAt:        { en: 'best at',                              ka: 'საუკეთესოდ' },
    // Missions section
    missionsTitle: { en: "Tonight's Missions",                   ka: 'დღეს ღამის მისიები' },
    missionsSub:   { en: 'Generated from real sky data',         ka: 'გენერირებული ცის რეალური მონაცემებიდან' },
    ...
    step1t:        { en: 'Check Tonight\'s Sky',                 ka: 'შეამოწმე ცა' },
    step1d:        { en: 'See which planets and objects are visible from Tbilisi right now', ka: 'ნახე რომელი პლანეტები და ობიექტები ჩანს თბილისიდან' },
    step2t:        { en: 'Accept a Mission',                     ka: 'მიიღე მისია' },
    step2d:        { en: 'Missions are generated nightly based on what\'s actually in the sky', ka: 'მისიები ყოველ ღამე იქმნება ცის რეალური მდგომარეობის მიხედვით' },
    step3t:        { en: 'Observe & Submit',                     ka: 'დააკვირდი და გაგზავნე' },
    step3d:        { en: 'Photograph the object and submit. Admin verifies and awards points', ka: 'გადაიღე ობიექტი და გაგზავნე. ადმინი ამოწმებს და ანიჭებს ქულებს' },
    // CTA
    ctaTitle:      { en: 'Ready to explore the sky?',            ka: 'მზახარ ცის გამოსაკვლევად?' },
    ctaBtn:        { en: 'Join Sky Astroman →',                  ka: 'შემოუერთდი →' },
    // Equipment labels
