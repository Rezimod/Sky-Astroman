    ...
    <footer className="hidden sm:block border-t border-white/10 bg-space-900 mt-auto relative z-10">
      <div className="max-w-7xl mx-auto px-6 py-10 flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="flex items-center gap-2 opacity-50">
          <Telescope size={18} className="text-space-accent" />
          <span className="text-base font-bold tracking-widest text-white uppercase">Skywatcher</span>
        </div>
        <p className="text-sm text-slate-500">© 2024 Skywatcher. {t('footer.tagline')}</p>
